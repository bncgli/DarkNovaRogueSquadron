...
2.  **File di Contesto:** Crea e aggiorna file Markdown o JSON nella directory `.junie/context/` all'interno della radice del progetto corrente (creala se non esiste).
