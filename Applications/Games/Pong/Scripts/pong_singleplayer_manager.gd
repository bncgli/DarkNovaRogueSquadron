...
@export var restart_scene_string: String = "res://Applications/Games/Pong/Scenes/pong_singleplayer.tscn"
...
func _on_main_menu_btn_pressed() -> void:
	load_scene("res://Applications/Games/Pong/Scenes/pong_main_menu.tscn")
