...
func _on_regular_single_btn_pressed() -> void:
	load_scene("res://Applications/Games/Pong/Scenes/pong_singleplayer.tscn")

func _on_survival_single_btn_pressed() -> void:
	load_scene("res://Applications/Games/Pong/Scenes/pong_survival.tscn")

func _on_multiplayer_btn_pressed() -> void:
	load_scene("res://Applications/Games/Pong/Scenes/pong_multiplayer.tscn")
