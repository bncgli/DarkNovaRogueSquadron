...
1. **Flusso Git (Obbligatorio)**:
   - Prima di iniziare qualsiasi modifica, creare ed eseguire il checkout sul branch dedicato: `applications/Logbook`.
...
- [ ] Flusso Git su branch `applications/Logbook` con commit finale.
